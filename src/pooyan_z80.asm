0000: AF          xor  a
0001: 32 80 A1    ld   ($A180),a
0004: C3 92 00    jp   $0092
0007: FF          rst  $38
0008: 77          ld   (hl),a
0009: 3C          inc  a
000A: 23          inc  hl
...
0053: 0F          rrca
0054: 33          inc  sp
0055: 31 24 22    ld   sp,$2224
0058: 21 15 13    ld   hl,$1315
005B: 11 07 06    ld   de,$0607
005E: 05          dec  b
005F: 04          inc  b
0060: 03          inc  bc
0061: 02          ld   (bc),a
0062: 01 FF FF    ld   bc,$FFFF
0065: FF          rst  $38
0066: C3 6D 06    jp   $066D
0069: 00          nop
006A: 11 22 04    ld   de,$0422
006D: 31 06 15    ld   sp,$1506
0070: 02          ld   (bc),a
0071: 33          inc  sp
0072: 07          rlca
0073: 21 03 24    ld   hl,$2403
0076: 05          dec  b
0077: 13          inc  de
0078: 01 00 33    ld   bc,$3300
007B: 05          dec  b
007C: 61          ld   h,c
007D: BE          cp   (hl)
007E: 05          dec  b
...
0089: 51          ld   d,c
008A: 05          dec  b
008B: 38 8A       jr   c,$0017
008D: 06 AD       ld   b,$AD
008F: BA          cp   d
0090: 05          dec  b
0091: CA 32 00    jp   z,$0032
0094: A0          and  b
0095: 31 00 90    ld   sp,$9000
...
014D: 32 00 A0    ld   ($A000),a
0150: 3A 00 A0    ld   a,($A000)
0153: 2F          cpl
0154: 0F          rrca
0155: 0F          rrca
0156: 47          ld   b,a
...
01A4: 32 00 A0    ld   ($A000),a
01A7: CD EA 01    call $01EA
01AA: AF          xor  a
01AB: CD 8F 0E    call $0E8F
01AE: 3E 01       ld   a,$01
01B0: 32 80 A1    ld   ($A180),a
...
01C6: 36 01       ld   (hl),$01
01C8: 32 00 A0    ld   ($A000),a
01CB: 21 C0 89    ld   hl,$89C0
01CE: AF          xor  a
01CF: 06 1E       ld   b,$1E
01D1: D7          rst  $10
01D2: C3 0F 02    jp   $020F
01D5: 32 00 A0    ld   ($A000),a
01D8: 18 FB       jr   $01D5
01DA: 0B          dec  bc
01DB: 32 00 A0    ld   ($A000),a
01DE: 3A 80 A0    ld   a,($A080)
01E1: CB 5F       bit  3,a
01E3: C0          ret  nz
01E4: 78          ld   a,b
01E5: B1          or   c
...
032D: 77          ld   (hl),a
032E: 2C          inc  l
032F: DD 7E 10    ld   a,(ix+$10)
0332: 77          ld   (hl),a
0333: 2C          inc  l
0334: DD 7E 04    ld   a,(ix+$04)
0337: 77          ld   (hl),a
0338: 2C          inc  l
0339: DD 7E 0F    ld   a,(ix+$0f)
033C: 77          ld   (hl),a
033D: 2C          inc  l
...
07F3: 0C          inc  c
07F4: 00          nop
07F5: 11 00 04    ld   de,$0400
07F8: 00          nop
07F9: 1D          dec  e
07FA: 03          inc  bc
07FB: 14          inc  d
07FC: 11 1C 1C    ld   de,$1C1C
07FF: 1C          inc  e
0800: 1C          inc  e
0801: 1C          inc  e
0802: 1C          inc  e
...
0821: 00          nop
0822: 00          nop
0823: 01 01 01    ld   bc,$0101
0826: 01 01 01    ld   bc,$0101
0829: 1B          dec  de
082A: 00          nop
082B: 0C          inc  c
082C: 00          nop
...
0835: 1F          rra
0836: 1F          rra
0837: 10 07       djnz $0840
0839: 1D          dec  e
083A: 03          inc  bc
083B: 10 10       djnz $084D
083D: 10 10       djnz $084F
083F: 10 10       djnz $0851
0841: 10 10       djnz $0853
0843: 10 10       djnz $0855
0845: 10 10       djnz $0857
0847: 10 10       djnz $0859
0849: 10 10       djnz $085B
084B: 10 10       djnz $085D
084D: 10 10       djnz $085F
084F: 10 10       djnz $0861
0851: 10 10       djnz $0863
0853: 10 10       djnz $0865
0855: 10 10       djnz $0867
0857: 10 11       djnz $086A
0859: 0D          dec  c
085A: 03          inc  bc
085B: 00          nop
085C: 00          nop
...
0894: 12          ld   (de),a
0895: 12          ld   (de),a
0896: 10 10       djnz $08A8
0898: 11 21 B5    ld   de,$B521
089B: 0B          dec  bc
089C: E5          push hl
089D: 3A 51 8E    ld   a,($8E51)
08A0: EF          rst  $28
08A1: B3          or   e
08A2: 08          ex   af,af'
08A3: E9          jp   (hl)
...
08AB: C8          ret  z
08AC: 0A          ld   a,(bc)
08AD: 32 0B 42    ld   ($420B),a
08B0: 74          ld   (hl),h
08B1: EA 76 AF    jp   pe,$AF76
...
0A84: 0A          ld   a,(bc)
0A85: 16 FF       ld   d,$FF
0A87: 10 40       djnz $0AC9
0A89: 40          ld   b,b
0A8A: 40          ld   b,b
0A8B: 10 10       djnz $0A9D
0A8D: 20 1F       jr   nz,$0AAE
0A8F: 1F          rra
0A90: 29          add  hl,hl
0A91: 11 1E 10    ld   de,$101E
0A94: 10 40       djnz $0AD6
0A96: 40          ld   b,b
0A97: 40          ld   b,b
0A98: 10 10       djnz $0AAA
0A9A: 12          ld   (de),a
0A9B: 25          dec  h
0A9C: 25          dec  h
0A9D: 29          add  hl,hl
0A9E: 11 1E 10    ld   de,$101E
0AA1: 10 40       djnz $0AE3
0AA3: 40          ld   b,b
0AA4: 40          ld   b,b
0AA5: 10 10       djnz $0AB7
0AA7: 1D          dec  e
0AA8: 11 1D 11    ld   de,$111D
0AAB: 10 10       djnz $0ABD
0AAD: 10 10       djnz $0ABF
0AAF: 40          ld   b,b
0AB0: 40          ld   b,b
0AB1: 40          ld   b,b
0AB2: 10 10       djnz $0AC4
0AB4: 27          daa
0AB5: 1F          rra
0AB6: 1C          inc  e
0AB7: 16 10       ld   d,$10
0AB9: 10 10       djnz $0ACB
0ABB: 10 40       djnz $0AFD
0ABD: 40          ld   b,b
0ABE: 40          ld   b,b
0ABF: 10 10       djnz $0AD1
0AC1: 12          ld   (de),a
0AC2: 1F          rra
0AC3: 23          inc  hl
0AC4: 23          inc  hl
0AC5: 10 10       djnz $0AD7
0AC7: 10 21       djnz $0AEA
0AC9: 41          ld   b,c
0ACA: 8D          adc  a,l
0ACB: 35          dec  (hl)
...
0FE5: 16 10       ld   d,$10
0FE7: 90          sub  b
0FE8: 10 A2       djnz $0F8C
0FEA: 10 3C       djnz $1028
0FEC: 11 4F 11    ld   de,$114F
0FEF: 3E 0F       ld   a,$0F
...
103E: CD EF 02    call $02EF
1041: C9          ret
1042: 3E 01       ld   a,$01
1044: 32 3F 8F    ld   ($8F3F),a
1047: DD 21 80 8A ld   ix,$8A80
...
1061: A7          and  a
1062: 3A A0 A0    ld   a,($A0A0)
1065: 20 03       jr   nz,$106A
1067: 3A C0 A0    ld   a,($A0C0)
106A: 2F          cpl
...
1244: 12          ld   (de),a
1245: 65          ld   h,l
1246: 38 96       jr   c,$11DE
1248: 14          inc  d
1249: E3          ex   (sp),hl
124A: 3B          dec  sp
124B: 92          sub  d
124C: 3C          inc  a
124D: DC 14 18    call c,$1814
1250: 15          dec  d
1251: 4D          ld   c,l
1252: 15          dec  d
1253: 69          ld   l,c
...
159E: 21 D1 15    ld   hl,$15D1
15A1: E5          push hl
15A2: 3A 0A 88    ld   a,($880A)
15A5: E6 1F       and  $1F
15A7: EF          rst  $28
15A8: 01 16 B7    ld   bc,$B716
15AB: 16 5D       ld   d,$5D
15AD: 17          rla
15AE: C1          pop  bc
15AF: 17          rla
...
1E49: 03          inc  bc
1E4A: 02          ld   (bc),a
1E4B: 01 14 30    ld   bc,$3014
1E4E: 36 3E       ld   (hl),$3E
1E50: 3C          inc  a
1E51: 22 3A 32    ld   ($323A),hl
1E54: 7F          ld   a,a
...
1E81: A7          and  a
1E82: 3A A0 A0    ld   a,($A0A0)
1E85: 20 03       jr   nz,$1E8A
1E87: 3A C0 A0    ld   a,($A0C0)
1E8A: 2F          cpl
...
1FA5: B6          or   (hl)
1FA6: 1F          rra
1FA7: C2 1F CE    jp   nz,$CE1F
1FAA: 1F          rra
1FAB: 44          ld   b,h
1FAC: 20 8E       jr   nz,$1F3C
1FAE: 8E          adc  a,(hl)
1FAF: 8E          adc  a,(hl)
1FB0: 8E          adc  a,(hl)
1FB1: 00          nop
...
1FE1: B3          or   e
1FE2: B2          or   d
1FE3: 10 10       djnz $1FF5
1FE5: 10 B7       djnz $1F9E
1FE7: B8          cp   b
1FE8: B9          cp   c
1FE9: B6          or   (hl)
1FEA: 09          add  hl,bc
...
1FED: B5          or   l
1FEE: B4          or   h
1FEF: 10 10       djnz $2001
1FF1: 10 02       djnz $1FF5
1FF3: 08          ex   af,af'
1FF4: 13          inc  de
1FF5: 17          rla
1FF6: 16 09       ld   d,$09
1FF8: 15          dec  d
1FF9: 11 A0 78    ld   de,$78A0
1FFC: CB 6F       bit  5,a
...
200C: C9          ret
200D: 11 20 26    ld   de,$2620
2010: 20 B2       jr   nz,$1FC4
2012: B3          or   e
2013: B2          or   d
2014: B6          or   (hl)
2015: 10 B6       djnz $1FCD
2017: B7          or   a
2018: B8          cp   b
2019: B9          cp   c
201A: B7          or   a
...
2047: 83          add  a,e
2048: 00          nop
2049: C3 83 00    jp   $0083
204C: C3 03 03    jp   $0303
204F: 03          inc  bc
2050: 0B          dec  bc
2051: 0B          dec  bc
2052: 4B          ld   c,e
...
205C: 83          add  a,e
205D: 00          nop
205E: C3 83 00    jp   $0083
2061: C3 03 03    jp   $0303
2064: 03          inc  bc
2065: 21 3F 86    ld   hl,$863F
2068: 11 E0 FF    ld   de,$FFE0
206B: 3A 08 89    ld   a,($8908)
206E: A7          and  a
206F: C8          ret  z
2070: 3D          dec  a
2071: 4F          ld   c,a
...
; ??? ROM read, protection?
208C: 21 6D 06    ld   hl,$066D
208F: 06 10       ld   b,$10
2091: 11 AA 20    ld   de,$20AA
2094: 1A          ld   a,(de)
2095: BE          cp   (hl)
2096: 20 0C       jr   nz,$20A4
2098: 13          inc  de
2099: 00          nop
209A: 3E 08       ld   a,$08
209C: 85          add  a,l
...
20B1: 0B          dec  bc
20B2: 06 15       ld   b,$15
20B4: 32 88 77    ld   ($7788),a
20B7: 3A 35 CD    ld   a,($CD35)
20BA: 05          dec  b
20BB: 0C          inc  c
20BC: 32 D1 3E    ld   ($3ED1),a
20BF: DD 2C       inc  ixl
20C1: 2C          inc  l
20C2: 0A          ld   a,(bc)
20C3: 10 1B       djnz $20E0
20C5: 1F          rra
20C6: 1E 11       ld   e,$11
20C8: 1D          dec  e
20C9: 19          add  hl,de
...
23BB: CD 25 33    call $3325
23BE: D1          pop  de
23BF: 2E 65       ld   l,$65
23C1: CD 25 33    call $3325
23C4: 2E A5       ld   l,$A5
...
23D3: CD 25 33    call $3325
23D6: C9          ret
23D7: DD 21 80 8A ld   ix,$8A80
...
2599: D5          push de
259A: CD 25 33    call $3325
259D: 11 A0 FF    ld   de,$FFA0
25A0: 19          add  hl,de
25A1: D1          pop  de
25A2: CD 25 33    call $3325
25A5: C9          ret
...
26CB: 00          nop
26CC: 40          ld   b,b
26CD: 10 00       djnz $26CF
26CF: 40          ld   b,b
26D0: 11 00 40    ld   de,$4000
26D3: 12          ld   (de),a
26D4: 00          nop
26D5: FF          rst  $38
26D6: D8          ret  c
...
274D: D1          pop  de
274E: D3 D2       out  ($D2),a
2750: D4 D5 D7    call nc,$D7D5
2753: D6 10       sub  $10
2755: C1          pop  bc
2756: CE C2       adc  a,$C2
2758: C3 C7 C4    jp   $C4C7
275B: C5          push bc
275C: C0          ret  nz
275D: FF          rst  $38
275E: 10 C9       djnz $2729
2760: CE CA       adc  a,$CA
2762: CB CF       set  1,a
2764: CC CD A0    call z,$A0CD
2767: FF          rst  $38
2768: D8          ret  c
2769: D9          exx
276A: DA DB DC    jp   c,$DCDB
276D: DD          db   $dd
276E: DE DF       sbc  a,$DF
2770: 3E C8       ld   a,$C8
2772: 3E C8       ld   a,$C8
...
2781: 27          daa
2782: 56          ld   d,(hl)
2783: 28 AD       jr   z,$2732
2785: 28 C5       jr   z,$274C
2787: 28 26       jr   z,$27AF
2789: 80          add  a,b
278A: 77          ld   (hl),a
278B: D7          rst  $10
278C: 0D          dec  c
278D: 20 FA       jr   nz,$2789
...
295B: C9          ret
295C: D2 24 30    jp   nc,$3024
295F: 14          inc  d
2960: 11 10 10    ld   de,$1010
2963: 12          ld   (de),a
2964: 12          ld   (de),a
2965: 12          ld   (de),a
2966: 12          ld   (de),a
...
2A78: C9          ret
2A79: 21 66 1C    ld   hl,$1C66
2A7C: 11 23 2B    ld   de,$2B23
2A7F: 06 68       ld   b,$68
2A81: 1A          ld   a,(de)
2A82: 96          sub  (hl)
2A83: C2 A0 29    jp   nz,$29A0
2A86: 23          inc  hl
2A87: 13          inc  de
...
2B05: 88          adc  a,b
2B06: 0A          ld   a,(bc)
2B07: 32 88 08    ld   ($0888),a
2B0A: 32 89 04    ld   ($0489),a
2B0D: 32 01 3E    ld   ($3E01),a
2B10: AD          xor  l
2B11: 20 B9       jr   nz,$2ACC
2B13: 5A          ld   e,d
2B14: 3E FA       ld   a,$FA
2B16: 10 19       djnz $2B31
2B18: 4F          ld   c,a
2B19: 81          add  a,c
2B1A: 7E          ld   a,(hl)
2B1B: 0A          ld   a,(bc)
...
2D03: 40          ld   b,b
2D04: 40          ld   b,b
2D05: 20 20       jr   nz,$2D27
2D07: 20 00       jr   nz,$2D09
2D09: 20 00       jr   nz,$2D0B
2D0B: 20 00       jr   nz,$2D0D
2D0D: 00          nop
2D0E: 20 00       jr   nz,$2D10
2D10: 00          nop
2D11: FF          rst  $38
2D12: 00          nop
2D13: 00          nop
2D14: 20 00       jr   nz,$2D16
2D16: 00          nop
2D17: 20 00       jr   nz,$2D19
2D19: 20 00       jr   nz,$2D1B
2D1B: 20 20       jr   nz,$2D3D
2D1D: 20 40       jr   nz,$2D5F
2D1F: 40          ld   b,b
2D20: 60          ld   h,b
2D21: 80          add  a,b
2D22: C0          ret  nz
...
2D52: F1          pop  af
2D53: F3          di
2D54: F2 A2 A1    jp   p,$A1A2
2D57: 10 10       djnz $2D69
2D59: 15          dec  d
2D5A: 00          nop
2D5B: 0A          ld   a,(bc)
2D5C: 0F          rrca
...
2F9A: 2F          cpl
2F9B: 1F          rra
2F9C: 30 3F       jr   nc,$2FDD
2F9E: 30 64       jr   nc,$3004
2FA0: 64          ld   h,h
2FA1: 60          ld   h,b
2FA2: 60          ld   h,b
2FA3: 60          ld   h,b
...
2FB2: 3C          inc  a
2FB3: 3C          inc  a
2FB4: 38 38       jr   c,$2FEE
2FB6: 30 30       jr   nc,$2FE8
2FB8: 30 2C       jr   nc,$2FE6
2FBA: 2C          inc  l
2FBB: 20 20       jr   nz,$2FDD
2FBD: 18 10       jr   $2FCF
2FBF: 58          ld   e,b
2FC0: 58          ld   e,b
2FC1: 58          ld   e,b
...
2FCD: 3C          inc  a
2FCE: 3C          inc  a
2FCF: 38 38       jr   c,$3009
2FD1: 34          inc  (hl)
2FD2: 34          inc  (hl)
2FD3: 30 30       jr   nc,$3005
2FD5: 2C          inc  l
2FD6: 2C          inc  l
2FD7: 28 28       jr   z,$3001
2FD9: 24          inc  h
2FDA: 24          inc  h
2FDB: 18 18       jr   $2FF5
2FDD: 10 08       djnz $2FE7
2FDF: 48          ld   c,b
2FE0: 48          ld   c,b
2FE1: 48          ld   c,b
2FE2: 44          ld   b,h
...
2FE5: 34          inc  (hl)
2FE6: 34          inc  (hl)
2FE7: 30 30       jr   nc,$3019
2FE9: 28 28       jr   z,$3013
2FEB: 24          inc  h
2FEC: 24          inc  h
2FED: 20 20       jr   nz,$300F
2FEF: 1C          inc  e
2FF0: 1C          inc  e
2FF1: 18 18       jr   $300B
2FF3: 14          inc  d
2FF4: 14          inc  d
2FF5: 10 10       djnz $3007
2FF7: 0C          inc  c
2FF8: 0C          inc  c
2FF9: 08          ex   af,af'
2FFA: 08          ex   af,af'
...
2FFD: 03          inc  bc
2FFE: 02          ld   (bc),a
2FFF: 38 38       jr   c,$3039
3001: 34          inc  (hl)
3002: 34          inc  (hl)
3003: 2C          inc  l
3004: 2C          inc  l
3005: 28 28       jr   z,$302F
3007: 24          inc  h
3008: 24          inc  h
3009: 20 20       jr   nz,$302B
300B: 1C          inc  e
300C: 1C          inc  e
300D: 18 18       jr   $3027
300F: 14          inc  d
3010: 14          inc  d
3011: 10 10       djnz $3023
3013: 0C          inc  c
3014: 0C          inc  c
3015: 08          ex   af,af'
3016: 08          ex   af,af'
...
301C: 02          ld   (bc),a
301D: 02          ld   (bc),a
301E: 01 20 20    ld   bc,$2020
3021: 20 1C       jr   nz,$303F
3023: 1C          inc  e
3024: 18 18       jr   $303E
3026: 14          inc  d
3027: 14          inc  d
3028: 10 10       djnz $303A
302A: 10 0C       djnz $3038
302C: 0C          inc  c
302D: 0C          inc  c
302E: 08          ex   af,af'
302F: 08          ex   af,af'
...
3035: 02          ld   (bc),a
3036: 02          ld   (bc),a
3037: 01 01 01    ld   bc,$0101
303A: 01 01 01    ld   bc,$0101
303D: 01 01 18    ld   bc,$1801
3040: 18 18       jr   $305A
3042: 18 14       jr   $3058
3044: 14          inc  d
3045: 14          inc  d
3046: 10 10       djnz $3058
3048: 10 0C       djnz $3056
304A: 0C          inc  c
304B: 0C          inc  c
304C: 08          ex   af,af'
304D: 08          ex   af,af'
...
3052: 02          ld   (bc),a
3053: 02          ld   (bc),a
3054: 01 01 01    ld   bc,$0101
3057: 01 01 01    ld   bc,$0101
305A: 01 01 01    ld   bc,$0101
305D: 01 01 DD    ld   bc,$DD01
3060: 7D          ld   a,l
3061: E6 03       and  $03
...
333F: 04          inc  b
3340: 17          rla
3341: 38 40       jr   c,$3383
3343: 04          inc  b
3344: 19          add  hl,de
3345: 3F          ccf
3346: 40          ld   b,b
3347: FF          rst  $38
3348: 20 00       jr   nz,$334A
334A: 20 00       jr   nz,$334C
334C: 20 00       jr   nz,$334E
334E: 20 00       jr   nz,$3350
3350: 20 10       jr   nz,$3362
3352: 20 10       jr   nz,$3364
3354: 20 10       jr   nz,$3366
3356: 20 10       jr   nz,$3368
3358: 20 18       jr   nz,$3372
335A: 20 18       jr   nz,$3374
335C: 20 18       jr   nz,$3376
335E: 20 18       jr   nz,$3378
3360: 18 20       jr   $3382
3362: 18 20       jr   $3384
3364: 18 20       jr   $3386
3366: 18 20       jr   $3388
3368: 10 28       djnz $3392
336A: 10 28       djnz $3394
336C: 10 28       djnz $3396
336E: 10 28       djnz $3398
3370: 10 30       djnz $33A2
3372: 10 30       djnz $33A4
3374: 10 30       djnz $33A6
3376: 00          nop
...
3726: C9          ret
3727: 00          nop
3728: 10 20       djnz $374A
372A: 30 40       jr   nc,$376C
372C: 50          ld   d,b
372D: 60          ld   h,b
372E: 70          ld   (hl),b
372F: 80          add  a,b
...
382E: 07          rlca
382F: 40          ld   b,b
3830: 28 07       jr   z,$3839
3832: 40          ld   b,b
3833: 27          daa
3834: 07          rlca
3835: FF          rst  $38
3836: 29          add  hl,hl
3837: 38 C0       jr   c,$37F9
3839: 26 07       ld   h,$07
383B: C0          ret  nz
383C: 27          daa
383D: 07          rlca
383E: C0          ret  nz
383F: 28 07       jr   z,$3848
3841: C0          ret  nz
3842: 27          daa
3843: 07          rlca
3844: FF          rst  $38
3845: 38 38       jr   c,$387F
3847: 44          ld   b,h
3848: 26 07       ld   h,$07
384A: 44          ld   b,h
384B: 27          daa
384C: 07          rlca
384D: 44          ld   b,h
384E: 28 07       jr   z,$3857
3850: 44          ld   b,h
3851: 27          daa
3852: 07          rlca
3853: FF          rst  $38
3854: 47          ld   b,a
3855: 38 C4       jr   c,$381B
3857: 26 07       ld   h,$07
3859: C4 27 07    call nz,$0727
385C: C4 28 07    call nz,$0728
385F: C4 27 07    call nz,$0727
3862: FF          rst  $38
3863: 56          ld   d,(hl)
3864: 38 CD       jr   c,$3833
3866: 06 40       ld   b,$40
...
389D: E6 9E       and  $9E
389F: C8          ret  z
38A0: 21 F0 8E    ld   hl,$8EF0
38A3: 34          inc  (hl)
38A4: C9          ret
38A5: 10 11       djnz $38B8
38A7: 12          ld   (de),a
38A8: 13          inc  de
38A9: 14          inc  d
38AA: 15          dec  d
...
38B4: 17          rla
38B5: CB 38       srl  b
38B7: DA 38 E9    jp   c,$E938
38BA: 38 F8       jr   c,$38B4
38BC: 38 07       jr   c,$38C5
38BE: 39          add  hl,sp
38BF: 16 39       ld   d,$39
38C1: 25          dec  h
38C2: 39          add  hl,sp
...
3969: 39          add  hl,sp
396A: 40          ld   b,b
396B: 2A 12 40    ld   hl,($4012)
396E: 2B          dec  hl
396F: 18 40       jr   $39B1
3971: 29          add  hl,hl
3972: 20 40       jr   nz,$39B4
3974: 1F          rra
3975: 10 FF       djnz $3976
3977: 70          ld   (hl),b
3978: 39          add  hl,sp
3979: 44          ld   b,h
397A: 2A 12 44    ld   hl,($4412)
397D: 2B          dec  hl
397E: 18 44       jr   $39C4
3980: 29          add  hl,hl
3981: 20 44       jr   nz,$39C7
3983: 1F          rra
3984: 10 FF       djnz $3985
3986: 7F          ld   a,a
3987: 39          add  hl,sp
3988: 40          ld   b,b
3989: 26 28       ld   h,$28
398B: 40          ld   b,b
398C: 29          add  hl,hl
398D: 20 40       jr   nz,$39CF
398F: 1F          rra
3990: 10 FF       djnz $3991
3992: 8B          adc  a,e
3993: 39          add  hl,sp
3994: 44          ld   b,h
3995: 26 28       ld   h,$28
3997: 44          ld   b,h
3998: 29          add  hl,hl
3999: 20 44       jr   nz,$39DF
399B: 1F          rra
399C: 10 FF       djnz $399D
399E: 97          sub  a
399F: 39          add  hl,sp
39A0: 40          ld   b,b
39A1: 2A 12 40    ld   hl,($4012)
39A4: 2B          dec  hl
39A5: 18 40       jr   $39E7
39A7: 06 10       ld   b,$10
39A9: 40          ld   b,b
39AA: 0B          dec  bc
39AB: 10 FF       djnz $39AC
39AD: A6          and  (hl)
39AE: 39          add  hl,sp
...
3B35: 0D          dec  c
3B36: 0D          dec  c
3B37: 20 1C       jr   nz,$3B55
3B39: 18 20       jr   $3B5B
3B3B: 28 30       jr   z,$3B6D
3B3D: 18 30       jr   $3B6F
3B3F: 20 22       jr   nz,$3B63
3B41: 24          inc  h
3B42: 26 28       ld   h,$28
3B44: 30 28       jr   nc,$3B6E
3B46: 30 67       jr   nc,$3BAF
3B48: 3B          dec  sp
3B49: 69          ld   l,c
3B4A: 3B          dec  sp
3B4B: 6B          ld   l,e
...
3B74: 58          ld   e,b
3B75: 40          ld   b,b
3B76: 30 40       jr   nc,$3BB8
3B78: 20 40       jr   nz,$3BBA
3B7A: 20 40       jr   nz,$3BBC
3B7C: 1C          inc  e
3B7D: 40          ld   b,b
3B7E: 1C          inc  e
3B7F: 40          ld   b,b
...
3BD6: 08          ex   af,af'
3BD7: 40          ld   b,b
3BD8: 32 09 40    ld   ($4009),a
3BDB: 31 20 40    ld   sp,$4020
3BDE: 00          nop
3BDF: F0          ret  p
3BE0: FF          rst  $38
3BE1: DD          db   $dd
...
3DB7: C7          rst  $00
3DB8: 3D          dec  a
3DB9: CD 3D 42    call $423D
3DBC: 30 F0       jr   nc,$3DAE
3DBE: FF          rst  $38
3DBF: BB          cp   e
3DC0: 3D          dec  a
3DC1: 41          ld   b,c
3DC2: 30 F0       jr   nc,$3DB4
3DC4: FF          rst  $38
3DC5: C1          pop  bc
3DC6: 3D          dec  a
3DC7: 49          ld   c,c
3DC8: 30 F0       jr   nc,$3DBA
3DCA: FF          rst  $38
3DCB: C7          rst  $00
3DCC: 3D          dec  a
3DCD: 40          ld   b,b
3DCE: 30 F0       jr   nc,$3DC0
3DD0: FF          rst  $38
3DD1: CD 3D EF    call $EF3D
3DD4: 3D          dec  a
3DD5: EF          rst  $28
3DD6: 3D          dec  a
3DD7: EF          rst  $28
...
3DF3: 33          inc  sp
3DF4: 06 44       ld   b,$44
3DF6: 32 07 44    ld   ($4407),a
3DF9: 31 12 40    ld   sp,$4012
3DFC: 34          inc  (hl)
3DFD: 05          dec  b
3DFE: 40          ld   b,b
3DFF: 33          inc  sp
3E00: 06 40       ld   b,$40
3E02: 32 07 40    ld   ($4007),a
3E05: 31 12 40    ld   sp,$4012
3E08: 34          inc  (hl)
3E09: 05          dec  b
3E0A: 40          ld   b,b
3E0B: 33          inc  sp
3E0C: 06 40       ld   b,$40
3E0E: 32 07 40    ld   ($4007),a
3E11: 31 12 80    ld   sp,$8012
3E14: 01 05 40    ld   bc,$4005
3E17: 1D          dec  e
3E18: 05          dec  b
3E19: 43          ld   b,e
3E1A: 39          add  hl,sp
3E1B: 28 80       jr   z,$3D9D
3E1D: 01 04 40    ld   bc,$4004
3E20: 1D          dec  e
3E21: 04          inc  b
3E22: 42          ld   b,d
3E23: 39          add  hl,sp
3E24: 28 80       jr   z,$3DA6
3E26: 01 03 40    ld   bc,$4003
3E29: 1D          dec  e
3E2A: 03          inc  bc
3E2B: 4F          ld   c,a
3E2C: 3A 38 84    ld   a,($8438)
3E2F: 01 05 44    ld   bc,$4405
3E32: 1D          dec  e
3E33: 05          dec  b
3E34: 43          ld   b,e
3E35: 39          add  hl,sp
3E36: 28 84       jr   z,$3DBC
3E38: 01 04 44    ld   bc,$4404
3E3B: 1D          dec  e
3E3C: 04          inc  b
3E3D: 42          ld   b,d
3E3E: 39          add  hl,sp
3E3F: 28 84       jr   z,$3DC5
3E41: 01 03 44    ld   bc,$4403
3E44: 1D          dec  e
3E45: 03          inc  bc
3E46: 4F          ld   c,a
3E47: 3A 38 5D    ld   a,($5D38)
3E4A: 3E 5D       ld   a,$5D
3E4C: 3E 5D       ld   a,$5D
3E4E: 3E 5D       ld   a,$5D
3E50: 3E 5D       ld   a,$5D
...
4079: 40          ld   b,b
407A: 80          add  a,b
407B: 01 08 40    ld   bc,$4008
407E: 1D          dec  e
407F: 08          ex   af,af'
4080: 80          add  a,b
4081: 01 08 40    ld   bc,$4008
4084: 1D          dec  e
4085: 08          ex   af,af'
4086: 40          ld   b,b
4087: 01 08 80    ld   bc,$8008
408A: 1D          dec  e
408B: 08          ex   af,af'
408C: FF          rst  $38
408D: 86          add  a,(hl)
408E: 40          ld   b,b
408F: 84          add  a,h
4090: 01 08 44    ld   bc,$4408
4093: 1D          dec  e
4094: 08          ex   af,af'
4095: 84          add  a,h
4096: 01 08 44    ld   bc,$4408
4099: 1D          dec  e
409A: 08          ex   af,af'
409B: 44          ld   b,h
409C: 01 08 84    ld   bc,$8408
409F: 1D          dec  e
40A0: 08          ex   af,af'
40A1: FF          rst  $38
40A2: 9B          sbc  a,e
...
40A8: 40          ld   b,b
40A9: 19          add  hl,de
40AA: 28 40       jr   z,$40EC
40AC: 19          add  hl,de
40AD: 38 44       jr   c,$40F3
40AF: 19          add  hl,de
40B0: 28 44       jr   z,$40F6
40B2: 19          add  hl,de
40B3: 30 45       jr   nc,$40FA
40B5: 34          inc  (hl)
40B6: 05          dec  b
40B7: 45          ld   b,l
40B8: 33          inc  sp
...
41BF: 33          inc  sp
41C0: 06 44       ld   b,$44
41C2: 32 07 44    ld   ($4407),a
41C5: 31 08 43    ld   sp,$4308
41C8: 37          scf
41C9: 38 41       jr   c,$420C
41CB: 34          inc  (hl)
41CC: 05          dec  b
41CD: 41          ld   b,c
41CE: 33          inc  sp
41CF: 06 41       ld   b,$41
41D1: 32 07 41    ld   ($4107),a
41D4: 31 08 43    ld   sp,$4308
41D7: 37          scf
41D8: 38 49       jr   c,$4223
41DA: 34          inc  (hl)
41DB: 05          dec  b
41DC: 49          ld   c,c
41DD: 33          inc  sp
41DE: 06 49       ld   b,$49
41E0: 32 07 49    ld   ($4907),a
41E3: 31 08 43    ld   sp,$4308
41E6: 37          scf
41E7: 38 40       jr   c,$4229
41E9: 34          inc  (hl)
41EA: 05          dec  b
41EB: 40          ld   b,b
41EC: 33          inc  sp
41ED: 06 40       ld   b,$40
41EF: 32 07 40    ld   ($4007),a
41F2: 31 08 48    ld   sp,$4808
41F5: 37          scf
41F6: 38 47       jr   c,$423F
41F8: 34          inc  (hl)
41F9: 05          dec  b
41FA: 47          ld   b,a
41FB: 33          inc  sp
41FC: 06 47       ld   b,$47
41FE: 32 07 47    ld   ($4707),a
4201: 31 12 44    ld   sp,$4412
4204: 26 09       ld   h,$09
4206: 44          ld   b,h
4207: 27          daa
4208: 09          add  hl,bc
4209: 44          ld   b,h
420A: 28 09       jr   z,$4215
420C: 44          ld   b,h
420D: 27          daa
420E: 09          add  hl,bc
420F: FF          rst  $38
4210: 03          inc  bc
4211: 42          ld   b,d
4212: C4 26 09    call nz,$0926
4215: C4 27 09    call nz,$0927
4218: C4 28 09    call nz,$0928
421B: C4 27 09    call nz,$0927
421E: FF          rst  $38
421F: 12          ld   (de),a
4220: 42          ld   b,d
...
4347: 44          ld   b,h
4348: 2C          inc  l
4349: 30 44       jr   nc,$438F
434B: 20 F0       jr   nz,$433D
434D: FF          rst  $38
434E: 4A          ld   c,d
434F: 43          ld   b,e
...
4A4F: C9          ret
4A50: 10 1D       djnz $4A6F
4A52: 10 08       djnz $4A5C
4A54: 40          ld   b,b
4A55: 10 04       djnz $4A5B
4A57: 40          ld   b,b
4A58: 10 03       djnz $4A5D
4A5A: 40          ld   b,b
4A5B: 10 03       djnz $4A60
4A5D: 40          ld   b,b
4A5E: 00          nop
4A5F: 80          add  a,b
4A60: 10 05       djnz $4A67
4A62: 10 1D       djnz $4A81
4A64: 10 17       djnz $4A7D
4A66: 80          add  a,b
4A67: 80          add  a,b
4A68: 10 04       djnz $4A6E
4A6A: 10 18       djnz $4A84
4A6C: 80          add  a,b
4A6D: 10 04       djnz $4A73
4A6F: 10 1D       djnz $4A8E
4A71: 10 03       djnz $4A76
4A73: 40          ld   b,b
4A74: 10 19       djnz $4A8F
4A76: 10 03       djnz $4A7B
4A78: 40          ld   b,b
4A79: 10 19       djnz $4A94
4A7B: 10 1D       djnz $4A9A
4A7D: 10 04       djnz $4A83
4A7F: 80          add  a,b
4A80: 80          add  a,b
4A81: 10 17       djnz $4A9A
4A83: 10 1A       djnz $4A9F
4A85: 07          rlca
4A86: 10 02       djnz $4A8A
4A88: 10 05       djnz $4A8F
4A8A: 80          add  a,b
4A8B: 10 17       djnz $4AA4
4A8D: 10 1D       djnz $4AAC
4A8F: 10 1D       djnz $4AAE
4A91: 10 05       djnz $4A98
4A93: 80          add  a,b
4A94: 10 14       djnz $4AAA
4A96: 0E 10       ld   c,$10
4A98: 02          ld   (bc),a
4A99: 10 1D       djnz $4AB8
4A9B: 10 03       djnz $4AA0
4A9D: 80          add  a,b
4A9E: 10 19       djnz $4AB9
4AA0: FF          rst  $38
4AA1: C2 82 02    jp   nz,$0282
4AA4: 10 04       djnz $4AAA
4AA6: 40          ld   b,b
4AA7: 10 18       djnz $4AC1
4AA9: 10 1D       djnz $4AC8
4AAB: 10 1D       djnz $4ACA
4AAD: 10 04       djnz $4AB3
4AAF: 80          add  a,b
4AB0: 10 18       djnz $4ACA
4AB2: 10 04       djnz $4AB8
4AB4: 80          add  a,b
4AB5: 10 02       djnz $4AB9
4AB7: 80          add  a,b
4AB8: 10 11       djnz $4ACB
4ABA: 40          ld   b,b
4ABB: 10 03       djnz $4AC0
4ABD: 10 07       djnz $4AC6
4ABF: 80          add  a,b
4AC0: 10 0B       djnz $4ACD
4AC2: 40          ld   b,b
4AC3: 10 05       djnz $4ACA
4AC5: 40          ld   b,b
4AC6: 00          nop
4AC7: 10 02       djnz $4ACB
4AC9: 10 08       djnz $4AD3
4ACB: 40          ld   b,b
4ACC: 10 04       djnz $4AD2
4ACE: 40          ld   b,b
4ACF: 02          ld   (bc),a
4AD0: 40          ld   b,b
4AD1: 10 06       djnz $4AD9
4AD3: 40          ld   b,b
4AD4: 10 06       djnz $4ADC
4AD6: 10 02       djnz $4ADA
4AD8: C0          ret  nz
4AD9: 10 04       djnz $4ADF
4ADB: 80          add  a,b
4ADC: 40          ld   b,b
4ADD: 80          add  a,b
4ADE: 00          nop
...
4AE0: 00          nop
4AE1: 40          ld   b,b
4AE2: 10 02       djnz $4AE6
4AE4: 40          ld   b,b
4AE5: 10 02       djnz $4AE9
4AE7: 40          ld   b,b
4AE8: 10 02       djnz $4AEC
4AEA: 40          ld   b,b
4AEB: 10 03       djnz $4AF0
4AED: 40          ld   b,b
4AEE: 10 02       djnz $4AF2
4AF0: FF          rst  $38
4AF1: A2          and  d
4AF2: 80          add  a,b
4AF3: 02          ld   (bc),a
4AF4: 10 10       djnz $4B06
4AF6: 80          add  a,b
4AF7: 80          add  a,b
4AF8: 10 0B       djnz $4B05
4AFA: 10 11       djnz $4B0D
4AFC: 80          add  a,b
4AFD: 10 0B       djnz $4B0A
4AFF: 10 1D       djnz $4B1E
4B01: 10 13       djnz $4B16
4B03: 07          rlca
4B04: 10 09       djnz $4B0F
4B06: 10 13       djnz $4B1B
4B08: 07          rlca
4B09: 10 09       djnz $4B14
4B0B: FF          rst  $38
4B0C: A2          and  d
4B0D: 82          add  a,d
4B0E: 0A          ld   a,(bc)
4B0F: 10 13       djnz $4B24
4B11: 0E 10       ld   c,$10
4B13: 09          add  hl,bc
4B14: 10 1D       djnz $4B33
4B16: 10 1D       djnz $4B35
4B18: 10 13       djnz $4B2D
4B1A: 0E 10       ld   c,$10
4B1C: 09          add  hl,bc
4B1D: 10 1D       djnz $4B3C
4B1F: 10 1D       djnz $4B3E
4B21: 10 13       djnz $4B36
4B23: 07          rlca
4B24: 10 09       djnz $4B2F
4B26: 10 13       djnz $4B3B
4B28: 07          rlca
4B29: 10 09       djnz $4B34
4B2B: 10 13       djnz $4B40
4B2D: 0E 10       ld   c,$10
4B2F: 09          add  hl,bc
4B30: FF          rst  $38
4B31: A2          and  d
4B32: 80          add  a,b
4B33: 02          ld   (bc),a
4B34: 10 10       djnz $4B46
4B36: 80          add  a,b
4B37: 80          add  a,b
4B38: 10 0B       djnz $4B45
4B3A: 10 11       djnz $4B4D
4B3C: 80          add  a,b
4B3D: 10 0B       djnz $4B4A
4B3F: FF          rst  $38
4B40: 42          ld   b,d
4B41: 81          add  a,c
4B42: 02          ld   (bc),a
4B43: 10 13       djnz $4B58
4B45: 07          rlca
4B46: 10 09       djnz $4B51
4B48: FF          rst  $38
4B49: C2 81 02    jp   nz,$0281
4B4C: 10 13       djnz $4B61
4B4E: 0E 10       ld   c,$10
4B50: 09          add  hl,bc
4B51: FF          rst  $38
4B52: C2 83 0E    jp   nz,$0E83
4B55: 10 1D       djnz $4B74
4B57: 10 06       djnz $4B5F
4B59: 07          rlca
4B5A: 10 05       djnz $4B61
4B5C: 40          ld   b,b
4B5D: 10 10       djnz $4B6F
4B5F: 10 1D       djnz $4B7E
4B61: 10 10       djnz $4B73
4B63: 80          add  a,b
4B64: 80          add  a,b
4B65: 10 0B       djnz $4B72
4B67: 10 11       djnz $4B7A
4B69: 80          add  a,b
4B6A: 10 0B       djnz $4B77
4B6C: 10 1D       djnz $4B8B
4B6E: 10 1D       djnz $4B8D
4B70: 10 13       djnz $4B85
4B72: 0E 10       ld   c,$10
4B74: 09          add  hl,bc
4B75: 10 01       djnz $4B78
4B77: C0          ret  nz
4B78: C0          ret  nz
4B79: 10 1A       djnz $4B95
4B7B: 10 01       djnz $4B7E
4B7D: 00          nop
4B7E: 00          nop
4B7F: 10 1A       djnz $4B9B
4B81: 10 01       djnz $4B84
4B83: 85          add  a,l
4B84: 82          add  a,d
4B85: 10 10       djnz $4B97
4B87: 0E 10       ld   c,$10
4B89: 09          add  hl,bc
4B8A: 10 01       djnz $4B8D
4B8C: 05          dec  b
4B8D: 02          ld   (bc),a
4B8E: 10 1A       djnz $4BAA
4B90: 10 01       djnz $4B93
4B92: 80          add  a,b
4B93: 80          add  a,b
4B94: 10 1A       djnz $4BB0
4B96: 10 01       djnz $4B99
4B98: 00          nop
4B99: 00          nop
4B9A: 10 04       djnz $4BA0
4B9C: 40          ld   b,b
4B9D: 10 15       djnz $4BB4
4B9F: 10 01       djnz $4BA2
4BA1: 8D          adc  a,l
4BA2: CD 10 04    call $0410
4BA5: 40          ld   b,b
4BA6: 10 15       djnz $4BBD
4BA8: 10 01       djnz $4BAB
4BAA: 0D          dec  c
4BAB: 4D          ld   c,l
4BAC: 10 1A       djnz $4BC8
4BAE: 10 01       djnz $4BB1
4BB0: 83          add  a,e
4BB1: C3 10 05    jp   $0510
4BB4: 80          add  a,b
4BB5: 80          add  a,b
4BB6: 10 13       djnz $4BCB
4BB8: 10 01       djnz $4BBB
4BBA: 03          inc  bc
4BBB: 43          ld   b,e
4BBC: 10 1A       djnz $4BD8
4BBE: 10 01       djnz $4BC1
4BC0: 80          add  a,b
4BC1: C0          ret  nz
4BC2: 10 06       djnz $4BCA
4BC4: 80          add  a,b
4BC5: 10 13       djnz $4BDA
4BC7: 10 01       djnz $4BCA
4BC9: 00          nop
4BCA: 00          nop
4BCB: 10 05       djnz $4BD2
4BCD: 80          add  a,b
4BCE: 10 14       djnz $4BE4
4BD0: FF          rst  $38
4BD1: 42          ld   b,d
4BD2: 83          add  a,e
4BD3: 03          inc  bc
4BD4: 10 08       djnz $4BDE
4BD6: 80          add  a,b
4BD7: 10 09       djnz $4BE2
4BD9: 40          ld   b,b
4BDA: 10 0A       djnz $4BE6
4BDC: 10 0A       djnz $4BE8
4BDE: 80          add  a,b
4BDF: 10 07       djnz $4BE8
4BE1: 40          ld   b,b
4BE2: 00          nop
4BE3: 10 09       djnz $4BEE
4BE5: 10 1D       djnz $4C04
4BE7: 10 09       djnz $4BF2
4BE9: 80          add  a,b
4BEA: 40          ld   b,b
4BEB: 00          nop
4BEC: 82          add  a,d
...
4BF2: 00          nop
4BF3: 40          ld   b,b
4BF4: 10 09       djnz $4BFF
4BF6: 10 1D       djnz $4C15
4BF8: 10 08       djnz $4C02
4BFA: 40          ld   b,b
4BFB: 10 04       djnz $4C01
4BFD: 40          ld   b,b
4BFE: 10 03       djnz $4C03
4C00: 40          ld   b,b
4C01: 10 03       djnz $4C06
4C03: 04          inc  b
4C04: 10 07       djnz $4C0D
4C06: 10 1D       djnz $4C25
4C08: 10 05       djnz $4C0F
4C0A: 10 18       djnz $4C24
4C0C: 10 1D       djnz $4C2B
4C0E: 10 1D       djnz $4C2D
4C10: 10 03       djnz $4C15
4C12: 80          add  a,b
4C13: 40          ld   b,b
4C14: 10 18       djnz $4C2E
4C16: FF          rst  $38
4C17: 82          add  a,d
4C18: 81          add  a,c
4C19: 02          ld   (bc),a
4C1A: 10 05       djnz $4C21
4C1C: 40          ld   b,b
4C1D: 10 14       djnz $4C33
4C1F: 8A          adc  a,d
4C20: 10 02       djnz $4C24
4C22: 10 04       djnz $4C28
4C24: 10 16       djnz $4C3C
4C26: 0A          ld   a,(bc)
4C27: 10 02       djnz $4C2B
4C29: 10 1D       djnz $4C48
4C2B: 10 05       djnz $4C32
4C2D: 10 18       djnz $4C47
4C2F: 10 04       djnz $4C35
4C31: 40          ld   b,b
4C32: 10 15       djnz $4C49
4C34: 85          add  a,l
4C35: 10 02       djnz $4C39
4C37: 10 1A       djnz $4C53
4C39: 05          dec  b
4C3A: 10 02       djnz $4C3E
4C3C: 10 04       djnz $4C42
4C3E: 80          add  a,b
4C3F: 10 18       djnz $4C59
4C41: 10 04       djnz $4C47
4C43: 80          add  a,b
4C44: 80          add  a,b
4C45: 10 17       djnz $4C5E
4C47: 10 05       djnz $4C4E
4C49: 80          add  a,b
4C4A: 10 14       djnz $4C60
4C4C: 86          add  a,(hl)
4C4D: 10 02       djnz $4C51
4C4F: 10 1A       djnz $4C6B
4C51: 06 10       ld   b,$10
4C53: 02          ld   (bc),a
4C54: 10 1D       djnz $4C73
4C56: 10 1D       djnz $4C75
4C58: 10 04       djnz $4C5E
4C5A: 80          add  a,b
4C5B: 80          add  a,b
4C5C: 10 17       djnz $4C75
4C5E: 10 06       djnz $4C66
4C60: 80          add  a,b
4C61: 10 16       djnz $4C79
4C63: 10 05       djnz $4C6A
4C65: 80          add  a,b
4C66: 80          add  a,b
4C67: 10 16       djnz $4C7F
4C69: 10 08       djnz $4C73
4C6B: 40          ld   b,b
4C6C: 40          ld   b,b
4C6D: 10 02       djnz $4C71
4C6F: 40          ld   b,b
4C70: 40          ld   b,b
4C71: 40          ld   b,b
4C72: 40          ld   b,b
4C73: 10 0D       djnz $4C82
4C75: 10 06       djnz $4C7D
4C77: 40          ld   b,b
4C78: 00          nop
4C79: 40          ld   b,b
4C7A: 40          ld   b,b
4C7B: 10 02       djnz $4C7F
4C7D: 40          ld   b,b
4C7E: 40          ld   b,b
4C7F: 40          ld   b,b
4C80: 40          ld   b,b
4C81: 10 0D       djnz $4C90
4C83: 10 04       djnz $4C89
4C85: 40          ld   b,b
4C86: 10 03       djnz $4C8B
4C88: 40          ld   b,b
4C89: 40          ld   b,b
4C8A: 40          ld   b,b
4C8B: 40          ld   b,b
...
4C8E: 40          ld   b,b
4C8F: 40          ld   b,b
4C90: 10 0D       djnz $4C9F
4C92: 10 03       djnz $4C97
4C94: E6 E7       and  $E7
4C96: 8E          adc  a,(hl)
4C97: 7A          ld   a,d
4C98: 7E          ld   a,(hl)
...
4CAC: 3C          inc  a
4CAD: 75          ld   (hl),l
4CAE: 10 03       djnz $4CB3
4CB0: E4 E5 7E    call po,$7EE5
4CB3: 7B          ld   a,e
4CB4: 79          ld   a,c
4CB5: 93          sub  e
4CB6: 9F          sbc  a,a
...
4CE1: 96          sub  (hl)
4CE2: 9E          sbc  a,(hl)
4CE3: 38 3C       jr   c,$4D21
4CE5: 75          ld   (hl),l
4CE6: 10 03       djnz $4CEB
4CE8: A8          xor  b
4CE9: A9          xor  c
4CEA: 9B          sbc  a,e
4CEB: 7E          ld   a,(hl)
4CEC: 88          adc  a,b
4CED: 10 07       djnz $4CF6
4CEF: 89          adc  a,c
4CF0: 86          add  a,(hl)
4CF1: 10 08       djnz $4CFB
4CF3: 86          add  a,(hl)
4CF4: 8A          adc  a,d
4CF5: 3C          inc  a
4CF6: 75          ld   (hl),l
4CF7: 10 03       djnz $4CFC
4CF9: AA          xor  d
4CFA: AB          xor  e
4CFB: 87          add  a,a
4CFC: 8C          adc  a,h
4CFD: 10 13       djnz $4D12
4CFF: 8B          adc  a,e
4D00: 3C          inc  a
4D01: 75          ld   (hl),l
4D02: 10 03       djnz $4D07
4D04: AF          xor  a
4D05: 37          scf
4D06: 37          scf
4D07: 37          scf
4D08: 34          inc  (hl)
4D09: 10 13       djnz $4D1E
4D0B: 3C          inc  a
4D0C: 75          ld   (hl),l
4D0D: 10 1B       djnz $4D2A
4D0F: 3C          inc  a
4D10: 75          ld   (hl),l
4D11: 10 1B       djnz $4D2E
4D13: 3C          inc  a
4D14: 75          ld   (hl),l
4D15: 10 1B       djnz $4D32
4D17: 3C          inc  a
4D18: 75          ld   (hl),l
4D19: 10 1B       djnz $4D36
4D1B: 3C          inc  a
4D1C: 75          ld   (hl),l
4D1D: 10 1B       djnz $4D3A
4D1F: 3C          inc  a
4D20: 75          ld   (hl),l
4D21: 10 1B       djnz $4D3E
4D23: 3C          inc  a
4D24: 75          ld   (hl),l
4D25: 10 1B       djnz $4D42
4D27: 3C          inc  a
4D28: 75          ld   (hl),l
4D29: 10 1B       djnz $4D46
4D2B: 3C          inc  a
4D2C: 75          ld   (hl),l
4D2D: 10 1B       djnz $4D4A
4D2F: 3C          inc  a
4D30: 75          ld   (hl),l
4D31: 10 1B       djnz $4D4E
4D33: 3C          inc  a
4D34: 75          ld   (hl),l
4D35: 10 1B       djnz $4D52
4D37: 3C          inc  a
4D38: 75          ld   (hl),l
4D39: 10 1B       djnz $4D56
4D3B: 3C          inc  a
4D3C: 75          ld   (hl),l
4D3D: 10 1B       djnz $4D5A
4D3F: 3C          inc  a
4D40: 75          ld   (hl),l
4D41: 87          add  a,a
4D42: 87          add  a,a
4D43: 10 19       djnz $4D5E
4D45: 3C          inc  a
4D46: 75          ld   (hl),l
4D47: 9C          sbc  a,h
4D48: 7E          ld   a,(hl)
4D49: 87          add  a,a
4D4A: 10 18       djnz $4D64
4D4C: 3C          inc  a
4D4D: 75          ld   (hl),l
4D4E: 85          add  a,l
4D4F: 76          halt
...
4D9A: 93          sub  e
4D9B: 9F          sbc  a,a
4D9C: 3A 3A 3A    ld   a,($3A3A)
4D9F: 3A 3A 3A    ld   a,($3A3A)
4DA2: 3A 3A 3A    ld   a,($3A3A)
4DA5: 3A 3A 3A    ld   a,($3A3A)
4DA8: 3A 3A 3A    ld   a,($3A3A)
4DAB: 3A 3A 97    ld   a,($973A)
4DAE: 94          sub  h
4DAF: 3C          inc  a
4DB0: 75          ld   (hl),l
4DB1: 7E          ld   a,(hl)
...
4E18: C0          ret  nz
4E19: 00          nop
4E1A: 10 02       djnz $4E1E
4E1C: 10 05       djnz $4E23
4E1E: 40          ld   b,b
4E1F: 00          nop
4E20: 80          add  a,b
4E21: 80          add  a,b
...
4E34: 00          nop
4E35: 00          nop
4E36: 10 05       djnz $4E3D
4E38: C0          ret  nz
4E39: 80          add  a,b
4E3A: 10 13       djnz $4E4F
4E3C: 80          add  a,b
4E3D: 00          nop
4E3E: 00          nop
4E3F: FF          rst  $38
...
4E42: 0D          dec  c
4E43: 40          ld   b,b
4E44: 10 1C       djnz $4E62
4E46: 10 01       djnz $4E49
4E48: 80          add  a,b
4E49: 10 1B       djnz $4E66
4E4B: 10 1D       djnz $4E6A
4E4D: 10 1D       djnz $4E6C
4E4F: 00          nop
4E50: 80          add  a,b
4E51: 10 1B       djnz $4E6E
4E53: 00          nop
4E54: 80          add  a,b
4E55: 10 02       djnz $4E59
4E57: 80          add  a,b
4E58: 10 14       djnz $4E6E
4E5A: 40          ld   b,b
4E5B: 10 03       djnz $4E60
4E5D: 10 04       djnz $4E63
4E5F: 80          add  a,b
4E60: 10 14       djnz $4E76
4E62: 40          ld   b,b
4E63: 10 03       djnz $4E68
4E65: 10 05       djnz $4E6C
4E67: 40          ld   b,b
4E68: 10 17       djnz $4E81
4E6A: 10 04       djnz $4E70
4E6C: 80          add  a,b
4E6D: 40          ld   b,b
4E6E: 80          add  a,b
4E6F: 00          nop
...
4E71: 40          ld   b,b
4E72: 40          ld   b,b
4E73: 10 02       djnz $4E77
4E75: 40          ld   b,b
4E76: 10 02       djnz $4E7A
4E78: 40          ld   b,b
4E79: 10 02       djnz $4E7D
4E7B: 40          ld   b,b
4E7C: 10 03       djnz $4E81
4E7E: 40          ld   b,b
4E7F: 10 05       djnz $4E86
4E81: 10 03       djnz $4E86
4E83: E6 E7       and  $E7
4E85: 57          ld   d,a
4E86: 72          ld   (hl),d
4E87: 67          ld   h,a
...
4E96: 4C          ld   c,h
4E97: 63          ld   h,e
4E98: 31 4F 4F    ld   sp,$4F4F
4E9B: 3C          inc  a
4E9C: 75          ld   (hl),l
4E9D: 10 03       djnz $4EA2
4E9F: E4 E5 57    call po,$57E5
4EA2: 72          ld   (hl),d
4EA3: 6B          ld   l,e
4EA4: 73          ld   (hl),e
4EA5: 73          ld   (hl),e
...
4ED3: 3C          inc  a
4ED4: 75          ld   (hl),l
4ED5: 10 03       djnz $4EDA
4ED7: A8          xor  b
4ED8: A9          xor  c
4ED9: A2          and  d
4EDA: A1          and  c
4EDB: 69          ld   l,c
4EDC: 3A 3A 66    ld   a,($663A)
4EDF: 65          ld   h,l
4EE0: 69          ld   l,c
4EE1: 3A 3A 66    ld   a,($663A)
4EE4: 69          ld   l,c
4EE5: 3A 3A 66    ld   a,($663A)
4EE8: 69          ld   l,c
4EE9: 3A 3A 2E    ld   a,($2E3A)
4EEC: 32 3D 81    ld   ($813D),a
4EEF: 3C          inc  a
4EF0: 75          ld   (hl),l
4EF1: 10 03       djnz $4EF6
4EF3: AA          xor  d
4EF4: AB          xor  e
4EF5: 10 12       djnz $4F09
4EF7: 33          inc  sp
4EF8: 30 42       jr   nc,$4F3C
4EFA: BD          cp   l
4EFB: 3C          inc  a
4EFC: 75          ld   (hl),l
4EFD: 10 03       djnz $4F02
4EFF: AF          xor  a
4F00: 37          scf
4F01: 37          scf
4F02: 37          scf
4F03: 34          inc  (hl)
4F04: 10 10       djnz $4F16
4F06: 6D          ld   l,l
4F07: 58          ld   e,b
4F08: 58          ld   e,b
4F09: 3C          inc  a
4F0A: 75          ld   (hl),l
4F0B: 10 03       djnz $4F10
4F0D: 87          add  a,a
4F0E: 87          add  a,a
4F0F: 10 16       djnz $4F27
4F11: 3C          inc  a
4F12: 75          ld   (hl),l
4F13: 10 03       djnz $4F18
4F15: 9B          sbc  a,e
4F16: 9D          sbc  a,l
4F17: 88          adc  a,b
4F18: 10 15       djnz $4F2F
4F1A: 3C          inc  a
4F1B: 75          ld   (hl),l
4F1C: 10 03       djnz $4F21
4F1E: 9C          sbc  a,h
4F1F: 82          add  a,d
4F20: 88          adc  a,b
4F21: 10 15       djnz $4F38
4F23: 3C          inc  a
4F24: 75          ld   (hl),l
4F25: 10 03       djnz $4F2A
4F27: 79          ld   a,c
4F28: 79          ld   a,c
4F29: 88          adc  a,b
4F2A: 10 01       djnz $4F2D
4F2C: 00          nop
4F2D: 10 13       djnz $4F42
4F2F: 3C          inc  a
4F30: 75          ld   (hl),l
4F31: 10 03       djnz $4F36
4F33: 9C          sbc  a,h
4F34: 82          add  a,d
4F35: 87          add  a,a
4F36: 10 01       djnz $4F39
4F38: 00          nop
4F39: 10 12       djnz $4F4D
4F3B: 2F          cpl
4F3C: 3C          inc  a
4F3D: 75          ld   (hl),l
4F3E: 10 03       djnz $4F43
4F40: 85          add  a,l
4F41: 76          halt
4F42: 87          add  a,a
4F43: 10 14       djnz $4F59
4F45: 2F          cpl
4F46: 3C          inc  a
4F47: 75          ld   (hl),l
4F48: 10 03       djnz $4F4D
4F4A: 9C          sbc  a,h
4F4B: 76          halt
4F4C: 87          add  a,a
4F4D: 10 15       djnz $4F64
4F4F: 3C          inc  a
4F50: 75          ld   (hl),l
4F51: 10 03       djnz $4F56
4F53: 9C          sbc  a,h
4F54: 79          ld   a,c
4F55: 9B          sbc  a,e
4F56: 10 15       djnz $4F6D
4F58: 3C          inc  a
4F59: 75          ld   (hl),l
4F5A: 10 03       djnz $4F5F
4F5C: 79          ld   a,c
4F5D: 76          halt
4F5E: 87          add  a,a
4F5F: 10 14       djnz $4F75
4F61: 2F          cpl
4F62: 3C          inc  a
4F63: 75          ld   (hl),l
4F64: 10 03       djnz $4F69
4F66: 80          add  a,b
4F67: 8D          adc  a,l
4F68: 10 02       djnz $4F6C
4F6A: 24          inc  h
4F6B: 10 12       djnz $4F7F
4F6D: 2F          cpl
4F6E: 3C          inc  a
4F6F: 75          ld   (hl),l
4F70: 10 03       djnz $4F75
4F72: 80          add  a,b
4F73: 76          halt
4F74: 87          add  a,a
4F75: 10 01       djnz $4F78
4F77: 1E 10       ld   e,$10
4F79: 13          inc  de
4F7A: 3C          inc  a
4F7B: 75          ld   (hl),l
4F7C: 10 03       djnz $4F81
4F7E: 85          add  a,l
4F7F: 76          halt
4F80: 9B          sbc  a,e
4F81: 10 01       djnz $4F84
4F83: 19          add  hl,de
4F84: 10 13       djnz $4F99
4F86: 3C          inc  a
4F87: 75          ld   (hl),l
4F88: 10 03       djnz $4F8D
4F8A: 85          add  a,l
4F8B: 82          add  a,d
4F8C: 9B          sbc  a,e
4F8D: 10 01       djnz $4F90
4F8F: 1F          rra
4F90: 10 12       djnz $4FA4
4F92: 2F          cpl
4F93: 3C          inc  a
4F94: 75          ld   (hl),l
4F95: 10 03       djnz $4F9A
4F97: 9C          sbc  a,h
4F98: 79          ld   a,c
4F99: 9B          sbc  a,e
4F9A: 10 01       djnz $4F9D
4F9C: 20 10       jr   nz,$4FAE
4F9E: 12          ld   (de),a
4F9F: 2F          cpl
4FA0: 3C          inc  a
4FA1: 75          ld   (hl),l
4FA2: 10 03       djnz $4FA7
4FA4: 9C          sbc  a,h
4FA5: 79          ld   a,c
4FA6: 9D          sbc  a,l
4FA7: 88          adc  a,b
4FA8: 10 14       djnz $4FBE
4FAA: 3C          inc  a
4FAB: 75          ld   (hl),l
4FAC: 10 03       djnz $4FB1
4FAE: 85          add  a,l
4FAF: 76          halt
4FB0: 76          halt
4FB1: 87          add  a,a
4FB2: 10 14       djnz $4FC8
4FB4: 3C          inc  a
4FB5: 75          ld   (hl),l
4FB6: 10 03       djnz $4FBB
4FB8: 7E          ld   a,(hl)
4FB9: 7B          ld   a,e
4FBA: 90          sub  b
4FBB: 8F          adc  a,a
4FBC: 8C          adc  a,h
4FBD: 10 13       djnz $4FD2
4FBF: 3C          inc  a
4FC0: 75          ld   (hl),l
4FC1: B7          or   a
4FC2: B8          cp   b
...
4FD7: 9D          sbc  a,l
4FD8: 88          adc  a,b
4FD9: 10 05       djnz $4FE0
4FDB: 89          adc  a,c
4FDC: 86          add  a,(hl)
4FDD: 10 08       djnz $4FE7
4FDF: 86          add  a,(hl)
4FE0: 8A          adc  a,d
4FE1: 3C          inc  a
4FE2: 75          ld   (hl),l
...
4FFB: 96          sub  (hl)
4FFC: 9E          sbc  a,(hl)
4FFD: 38 3C       jr   c,$503B
4FFF: 75          ld   (hl),l
5000: 10 03       djnz $5005
5002: 9C          sbc  a,h
5003: 8E          adc  a,(hl)
5004: 7A          ld   a,d
5005: 78          ld   a,b
...
5037: 3C          inc  a
5038: 75          ld   (hl),l
5039: 10 1D       djnz $5058
503B: 10 08       djnz $5045
503D: 40          ld   b,b
503E: 10 04       djnz $5044
5040: 40          ld   b,b
5041: 10 03       djnz $5046
5043: 40          ld   b,b
5044: 10 03       djnz $5049
5046: 40          ld   b,b
5047: 00          nop
5048: 80          add  a,b
5049: 10 05       djnz $5050
504B: 10 1D       djnz $506A
504D: 10 17       djnz $5066
504F: 80          add  a,b
5050: 80          add  a,b
5051: 10 04       djnz $5057
5053: 10 18       djnz $506D
5055: 80          add  a,b
5056: 10 04       djnz $505C
5058: 10 1D       djnz $5077
505A: 10 03       djnz $505F
505C: 40          ld   b,b
505D: 10 19       djnz $5078
505F: 10 03       djnz $5064
5061: 40          ld   b,b
5062: 10 19       djnz $507D
5064: 10 1D       djnz $5083
5066: 10 04       djnz $506C
5068: 80          add  a,b
5069: 80          add  a,b
506A: 10 17       djnz $5083
506C: 10 1A       djnz $5088
506E: 8A          adc  a,d
506F: 10 02       djnz $5073
5071: 10 05       djnz $5078
5073: 80          add  a,b
5074: 10 14       djnz $508A
5076: 0A          ld   a,(bc)
5077: 10 02       djnz $507B
5079: 10 1D       djnz $5098
507B: 10 1D       djnz $509A
507D: 10 05       djnz $5084
507F: 80          add  a,b
5080: 10 14       djnz $5096
5082: 85          add  a,l
5083: 10 02       djnz $5087
5085: 10 1A       djnz $50A1
5087: 05          dec  b
5088: 10 02       djnz $508C
508A: 10 03       djnz $508F
508C: 80          add  a,b
508D: 10 19       djnz $50A8
508F: 10 1D       djnz $50AE
5091: 10 1A       djnz $50AD
5093: 86          add  a,(hl)
5094: 10 02       djnz $5098
5096: 10 1A       djnz $50B2
5098: 06 10       ld   b,$10
509A: 02          ld   (bc),a
509B: 10 04       djnz $50A1
509D: 40          ld   b,b
509E: 10 18       djnz $50B8
50A0: 10 1D       djnz $50BF
50A2: 10 1D       djnz $50C1
50A4: 80          add  a,b
50A5: 80          add  a,b
50A6: 80          add  a,b
50A7: 00          nop
50A8: 80          add  a,b
50A9: 10 18       djnz $50C3
50AB: 80          add  a,b
50AC: 00          nop
50AD: C0          ret  nz
50AE: 00          nop
50AF: 80          add  a,b
50B0: 10 02       djnz $50B4
50B2: 80          add  a,b
50B3: 10 11       djnz $50C6
50B5: 40          ld   b,b
50B6: 10 03       djnz $50BB
50B8: 80          add  a,b
50B9: 80          add  a,b
50BA: C0          ret  nz
50BB: 10 04       djnz $50C1
50BD: 80          add  a,b
50BE: 10 0B       djnz $50CB
50C0: 40          ld   b,b
50C1: 10 05       djnz $50C8
50C3: 40          ld   b,b
50C4: 00          nop
50C5: 10 02       djnz $50C9
50C7: 10 02       djnz $50CB
50C9: C0          ret  nz
50CA: 10 05       djnz $50D1
50CC: 40          ld   b,b
50CD: 10 04       djnz $50D3
50CF: 40          ld   b,b
50D0: 02          ld   (bc),a
50D1: 40          ld   b,b
50D2: 10 06       djnz $50DA
50D4: 40          ld   b,b
50D5: 10 06       djnz $50DD
50D7: 10 02       djnz $50DB
50D9: C0          ret  nz
50DA: 10 04       djnz $50E0
50DC: 80          add  a,b
50DD: 40          ld   b,b
50DE: 80          add  a,b
50DF: 00          nop
...
50E1: 00          nop
50E2: 40          ld   b,b
50E3: 10 02       djnz $50E7
50E5: 40          ld   b,b
50E6: 10 02       djnz $50EA
50E8: 40          ld   b,b
50E9: 10 02       djnz $50ED
50EB: 40          ld   b,b
50EC: 10 03       djnz $50F1
50EE: 40          ld   b,b
50EF: 10 02       djnz $50F3
...
519A: BA          cp   d
519B: 51          ld   d,c
519C: C2 51 CA    jp   nz,$CA51
519F: 51          ld   d,c
51A0: D4 51 DE    call nc,$DE51
51A3: 51          ld   d,c
51A4: E8          ret  pe
51A5: 51          ld   d,c
51A6: F4 51 00    call p,$0051
51A9: 52          ld   d,d
51AA: 0C          inc  c
51AB: 52          ld   d,d
51AC: 16 52       ld   d,$52
51AE: 20 52       jr   nz,$5202
51B0: 2A 52 36    ld   hl,($3652)
51B3: 52          ld   d,d
51B4: 42          ld   b,d
51B5: 52          ld   d,d
51B6: 4E          ld   c,(hl)
...
51B8: 5A          ld   e,d
51B9: 52          ld   d,d
51BA: 20 00       jr   nz,$51BC
51BC: 18 00       jr   $51BE
51BE: 10 00       djnz $51C0
51C0: 05          dec  b
51C1: 02          ld   (bc),a
51C2: 20 04       jr   nz,$51C8
51C4: 18 02       jr   $51C8
51C6: 10 05       djnz $51CD
51C8: 05          dec  b
51C9: 02          ld   (bc),a
51CA: 28 05       jr   z,$51D1
51CC: 20 00       jr   nz,$51CE
51CE: 18 05       jr   $51D5
51D0: 10 01       djnz $51D3
51D2: 05          dec  b
51D3: 04          inc  b
51D4: 28 01       jr   z,$51D7
51D6: 20 02       jr   nz,$51DA
51D8: 18 02       jr   $51DC
51DA: 10 01       djnz $51DD
51DC: 05          dec  b
51DD: 04          inc  b
51DE: 28 02       jr   z,$51E2
51E0: 20 01       jr   nz,$51E3
51E2: 18 03       jr   $51E7
51E4: 10 04       djnz $51EA
51E6: 05          dec  b
51E7: 04          inc  b
51E8: 30 00       jr   nc,$51EA
51EA: 28 06       jr   z,$51F2
51EC: 20 05       jr   nz,$51F3
51EE: 18 03       jr   $51F3
51F0: 10 00       djnz $51F2
51F2: 05          dec  b
51F3: 04          inc  b
51F4: 30 08       jr   nc,$51FE
51F6: 28 04       jr   z,$51FC
51F8: 20 05       jr   nz,$51FF
51FA: 18 06       jr   $5202
51FC: 10 07       djnz $5205
51FE: 05          dec  b
51FF: 04          inc  b
5200: 30 06       jr   nc,$5208
5202: 28 07       jr   z,$520B
5204: 20 00       jr   nz,$5206
5206: 18 05       jr   $520D
5208: 10 02       djnz $520C
520A: 05          dec  b
520B: 04          inc  b
520C: 28 09       jr   z,$5217
520E: 20 00       jr   nz,$5210
5210: 18 05       jr   $5217
5212: 10 03       djnz $5217
5214: 05          dec  b
5215: 04          inc  b
5216: 28 01       jr   z,$5219
5218: 20 02       jr   nz,$521C
521A: 18 02       jr   $521E
521C: 10 07       djnz $5225
521E: 05          dec  b
521F: 04          inc  b
5220: 28 02       jr   z,$5224
5222: 20 01       jr   nz,$5225
5224: 18 03       jr   $5229
5226: 10 08       djnz $5230
5228: 05          dec  b
5229: 04          inc  b
522A: 30 04       jr   nc,$5230
522C: 28 07       jr   z,$5235
522E: 20 02       jr   nz,$5232
5230: 18 06       jr   $5238
5232: 10 01       djnz $5235
5234: 05          dec  b
5235: 04          inc  b
5236: 30 04       jr   nc,$523C
5238: 28 01       jr   z,$523B
523A: 20 06       jr   nz,$5242
523C: 18 00       jr   $523E
523E: 10 09       djnz $5249
5240: 05          dec  b
5241: 04          inc  b
5242: 30 07       jr   nc,$524B
5244: 28 06       jr   z,$524C
5246: 20 00       jr   nz,$5248
5248: 18 05       jr   $524F
524A: 10 02       djnz $524E
524C: 05          dec  b
524D: 04          inc  b
524E: 2B          dec  hl
524F: 09          add  hl,bc
...
5258: 05          dec  b
5259: 02          ld   (bc),a
525A: 28 00       jr   z,$525C
525C: 20 02       jr   nz,$5260
525E: 18 06       jr   $5266
5260: 10 07       djnz $5269
5262: 05          dec  b
5263: 04          inc  b
5264: 78          ld   a,b
5265: 52          ld   d,d
...
5276: A9          xor  c
5277: 52          ld   d,d
5278: 01 1E 18    ld   bc,$181E
527B: 14          inc  d
527C: 10 10       djnz $528E
527E: FF          rst  $38
527F: 01 30 30    ld   bc,$3030
5282: 34          inc  (hl)
5283: 30 30       jr   nc,$52B5
5285: FF          rst  $38
5286: 01 18 50    ld   bc,$5018
5289: 38 38       jr   c,$52C3
528B: 30 FF       jr   nc,$528C
528D: 01 38 38    ld   bc,$3838
5290: 58          ld   e,b
5291: 18 30       jr   $52C3
5293: FF          rst  $38
5294: 01 38 38    ld   bc,$3838
5297: 38 38       jr   c,$52D1
5299: 38 FF       jr   c,$529A
529B: 01 30 30    ld   bc,$3030
529E: 30 30       jr   nc,$52D0
52A0: 30 FF       jr   nc,$52A1
52A2: 01 50 20    ld   bc,$2050
52A5: 3E 60       ld   a,$60
52A7: 40          ld   b,b
52A8: FF          rst  $38
52A9: 01 10 60    ld   bc,$6010
52AC: 58          ld   e,b
52AD: 60          ld   h,b
52AE: 30 FF       jr   nc,$52AF
52B0: C4 52 C9    call nz,$C952
52B3: 52          ld   d,d
52B4: CE 52       adc  a,$52
52B6: D3 52       out  ($52),a
52B8: D8          ret  c
...
52BA: DD          db   $dd
52BB: 52          ld   d,d
52BC: E2 52 E7    jp   po,$E752
52BF: 52          ld   d,d
52C0: EC 52 F1    call pe,$F152
52C3: 52          ld   d,d
52C4: 08          ex   af,af'
52C5: 0A          ld   a,(bc)
52C6: 0D          dec  c
52C7: 10 12       djnz $52DB
52C9: 13          inc  de
52CA: 10 0D       djnz $52D9
52CC: 0A          ld   a,(bc)
52CD: 07          rlca
52CE: 0E 10       ld   c,$10
52D0: 0B          dec  bc
52D1: 09          add  hl,bc
52D2: 07          rlca
52D3: 10 0E       djnz $52E3
52D5: 0C          inc  c
52D6: 08          ex   af,af'
52D7: 0A          ld   a,(bc)
52D8: 10 0E       djnz $52E8
52DA: 0C          inc  c
52DB: 0A          ld   a,(bc)
52DC: 08          ex   af,af'
52DD: 08          ex   af,af'
...
52E5: 0D          dec  c
52E6: 0D          dec  c
52E7: 10 10       djnz $52F9
52E9: 10 10       djnz $52FB
52EB: 10 14       djnz $5301
52ED: 08          ex   af,af'
52EE: 0E 14       ld   c,$14
52F0: 08          ex   af,af'
52F1: 0E 14       ld   c,$14
...
55DB: 18 10       jr   $55ED
55DD: 28 18       jr   z,$55F7
55DF: 20 10       jr   nz,$55F1
55E1: 18 20       jr   $5603
55E3: 18 20       jr   $5605
55E5: 10 28       djnz $560F
55E7: 18 20       jr   $5609
55E9: 10 18       djnz $5603
55EB: 28 18       jr   z,$5605
55ED: 18 20       jr   $560F
55EF: 40          ld   b,b
55F0: 50          ld   d,b
55F1: 60          ld   h,b
...
55F9: E0          ret  po
55FA: F0          ret  p
55FB: 10 20       djnz $561D
55FD: 30 40       jr   nc,$563F
55FF: F0          ret  p
5600: E0          ret  po
5601: D0          ret  nc
5602: C0          ret  nz
...
5609: 50          ld   d,b
560A: 40          ld   b,b
560B: 30 20       jr   nc,$562D
560D: 10 F0       djnz $55FF
560F: 20 30       jr   nz,$5641
5611: 40          ld   b,b
5612: 20 20       jr   nz,$5634
5614: 50          ld   d,b
5615: 40          ld   b,b
5616: 30 20       jr   nc,$5638
5618: 60          ld   h,b
5619: 20 30       jr   nz,$564B
561B: 40          ld   b,b
561C: 70          ld   (hl),b
561D: 30 40       jr   nc,$565F
561F: 27          daa
5620: 56          ld   d,(hl)
5621: 37          scf
5622: 56          ld   d,(hl)
...
5635: 00          nop
5636: 00          nop
5637: 01 03 01    ld   bc,$0103
563A: 01 01 01    ld   bc,$0101
563D: 01 00 03    ld   bc,$0300
5640: 03          inc  bc
5641: 01 01 00    ld   bc,$0001
5644: 00          nop
5645: 01 01 02    ld   bc,$0201
5648: 02          ld   (bc),a
5649: 02          ld   (bc),a
564A: 02          ld   (bc),a
564B: 02          ld   (bc),a
564C: 02          ld   (bc),a
564D: 01 02 02    ld   bc,$0202
5650: 00          nop
5651: 02          ld   (bc),a
5652: 03          inc  bc
5653: 02          ld   (bc),a
...
565D: B2          or   d
565E: 56          ld   d,(hl)
565F: CD 56 44    call $4456
5662: 3C          inc  a
5663: 10 44       djnz $56A9
5665: 3D          dec  a
5666: 10 44       djnz $56AC
5668: 3E 10       ld   a,$10
566A: 44          ld   b,h
566B: E1          pop  hl
566C: 10 44       djnz $56B2
566E: E2 10 44    jp   po,$4410
5671: E1          pop  hl
5672: 10 44       djnz $56B8
5674: E2 10 44    jp   po,$4410
5677: E1          pop  hl
5678: 10 FF       djnz $5679
567A: 6D          ld   l,l
567B: 56          ld   d,(hl)
567C: 41          ld   b,c
567D: 3C          inc  a
567E: 10 41       djnz $56C1
5680: 3D          dec  a
5681: 10 41       djnz $56C4
5683: 3E 10       ld   a,$10
5685: 41          ld   b,c
5686: E1          pop  hl
5687: 10 41       djnz $56CA
5689: E2 10 41    jp   po,$4110
568C: E1          pop  hl
568D: 10 41       djnz $56D0
568F: E2 10 41    jp   po,$4110
5692: E1          pop  hl
5693: 10 FF       djnz $5694
5695: 88          adc  a,b
5696: 56          ld   d,(hl)
5697: 49          ld   c,c
5698: 3C          inc  a
5699: 10 49       djnz $56E4
569B: 3D          dec  a
569C: 10 49       djnz $56E7
569E: 3E 10       ld   a,$10
56A0: 49          ld   c,c
56A1: E1          pop  hl
56A2: 10 49       djnz $56ED
56A4: E2 10 49    jp   po,$4910
56A7: E1          pop  hl
56A8: 10 49       djnz $56F3
56AA: E2 10 49    jp   po,$4910
56AD: E1          pop  hl
56AE: 10 FF       djnz $56AF
56B0: A3          and  e
56B1: 56          ld   d,(hl)
56B2: 4C          ld   c,h
56B3: 3C          inc  a
56B4: 10 4C       djnz $5702
56B6: 3D          dec  a
56B7: 10 4C       djnz $5705
56B9: 3E 10       ld   a,$10
56BB: 4C          ld   c,h
56BC: E1          pop  hl
56BD: 10 4C       djnz $570B
56BF: E2 10 4C    jp   po,$4C10
56C2: E1          pop  hl
56C3: 10 4C       djnz $5711
56C5: E2 10 4C    jp   po,$4C10
56C8: E1          pop  hl
56C9: 10 FF       djnz $56CA
56CB: BE          cp   (hl)
56CC: 56          ld   d,(hl)
56CD: 40          ld   b,b
56CE: 3C          inc  a
56CF: 10 40       djnz $5711
56D1: 3D          dec  a
56D2: 10 40       djnz $5714
56D4: 3E 10       ld   a,$10
56D6: 40          ld   b,b
56D7: E1          pop  hl
56D8: 10 40       djnz $571A
56DA: E2 10 40    jp   po,$4010
56DD: E1          pop  hl
56DE: 10 40       djnz $5720
56E0: E2 10 40    jp   po,$4010
56E3: E1          pop  hl
56E4: 10 FF       djnz $56E5
56E6: D9          exx
56E7: 56          ld   d,(hl)
...
58A4: 48          ld   c,b
58A5: 40          ld   b,b
58A6: 38 30       jr   c,$58D8
58A8: 2C          inc  l
58A9: 28 24       jr   z,$58CF
58AB: 20 1E       jr   nz,$58CB
58AD: 1C          inc  e
58AE: 1A          ld   a,(de)
58AF: 18 17       jr   $58C8
58B1: 17          rla
...
58C4: 48          ld   c,b
58C5: 40          ld   b,b
58C6: 38 30       jr   c,$58F8
58C8: 2C          inc  l
58C9: 28 24       jr   z,$58EF
58CB: 20 1E       jr   nz,$58EB
58CD: 1C          inc  e
58CE: 1A          ld   a,(de)
58CF: 18 17       jr   $58E8
58D1: 17          rla
...
58DE: 14          inc  d
58DF: 14          inc  d
58E0: 10 10       djnz $58F2
58E2: 10 10       djnz $58F4
58E4: 11 11 12    ld   de,$1211
58E7: 12          ld   (de),a
58E8: 13          inc  de
58E9: 13          inc  de
58EA: 13          inc  de
...
5930: 05          dec  b
5931: 00          nop
5932: 01 03 00    ld   bc,$0003
5935: 01 04 00    ld   bc,$0004
5938: 01 05 00    ld   bc,$0005
593B: 02          ld   (bc),a
593C: 02          ld   (bc),a
593D: 00          nop
593E: 02          ld   (bc),a
...
5955: 00          nop
5956: 05          dec  b
5957: 01 00 06    ld   bc,$0600
595A: 00          nop
595B: 00          nop
595C: 05          dec  b
595D: 01 00 06    ld   bc,$0600
5960: 00          nop
5961: 00          nop
5962: 05          dec  b
5963: 01 00 06    ld   bc,$0600
5966: 00          nop
5967: 00          nop
5968: 04          inc  b
5969: 02          ld   (bc),a
...
5985: 00          nop
5986: 00          nop
5987: 01 00 00    ld   bc,$0000
598A: 03          inc  bc
598B: 00          nop
598C: 00          nop
598D: 06 00       ld   b,$00
598F: 01 04 00    ld   bc,$0004
5992: 01 05 00    ld   bc,$0005
5995: 02          ld   (bc),a
5996: 03          inc  bc
5997: 00          nop
5998: 02          ld   (bc),a
...
59A9: 00          nop
59AA: 05          dec  b
59AB: 01 01 02    ld   bc,$0201
59AE: 01 01 01    ld   bc,$0101
59B1: 03          inc  bc
59B2: 01 01 04    ld   bc,$0401
59B5: 01 02 03    ld   bc,$0302
59B8: 02          ld   (bc),a
59B9: 00          nop
59BA: 00          nop
59BB: 02          ld   (bc),a
59BC: 01 02 02    ld   bc,$0202
59BF: 00          nop
59C0: 01 02 02    ld   bc,$0202
59C3: 01 03 01    ld   bc,$0103
59C6: 01 03 00    ld   bc,$0003
59C9: 01 03 02    ld   bc,$0203
59CC: 00          nop
59CD: 03          inc  bc
59CE: 00          nop
59CF: 02          ld   (bc),a
...
59D2: 00          nop
59D3: 03          inc  bc
59D4: 01 02 03    ld   bc,$0302
59D7: 00          nop
59D8: 03          inc  bc
59D9: 04          inc  b
59DA: 01 00 04    ld   bc,$0400
59DD: 01 00 04    ld   bc,$0400
59E0: 00          nop
59E1: 02          ld   (bc),a
59E2: 04          inc  b
59E3: 00          nop
...
5CA7: 5C          ld   e,h
5CA8: 40          ld   b,b
5CA9: 20 10       jr   nz,$5CBB
5CAB: 40          ld   b,b
5CAC: 22 F0 FF    ld   ($FFF0),hl
5CAF: AB          xor  e
5CB0: 5C          ld   e,h
5CB1: 41          ld   b,c
5CB2: 20 10       jr   nz,$5CC4
5CB4: 41          ld   b,c
5CB5: 22 F0 FF    ld   ($FFF0),hl
5CB8: B4          or   h
5CB9: 5C          ld   e,h
5CBA: 44          ld   b,h
5CBB: 20 10       jr   nz,$5CCD
5CBD: 44          ld   b,h
5CBE: 22 F0 FF    ld   ($FFF0),hl
5CC1: BD          cp   l
5CC2: 5C          ld   e,h
5CC3: 49          ld   c,c
5CC4: 20 10       jr   nz,$5CD6
5CC6: 49          ld   c,c
5CC7: 22 F0 FF    ld   ($FFF0),hl
5CCA: C6 5C       add  a,$5C
5CCC: 4A          ld   c,d
5CCD: 20 10       jr   nz,$5CDF
5CCF: 4A          ld   c,d
5CD0: 22 F0 FF    ld   ($FFF0),hl
5CD3: CF          rst  $08
5CD4: 5C          ld   e,h
5CD5: 41          ld   b,c
5CD6: 20 10       jr   nz,$5CE8
5CD8: 41          ld   b,c
5CD9: 22 F0 FF    ld   ($FFF0),hl
5CDC: D8          ret  c
5CDD: 5C          ld   e,h
5CDE: 44          ld   b,h
5CDF: 20 10       jr   nz,$5CF1
5CE1: 44          ld   b,h
5CE2: 22 F0 FF    ld   ($FFF0),hl
5CE5: E1          pop  hl
5CE6: 5C          ld   e,h
5CE7: 4E          ld   c,(hl)
5CE8: 20 10       jr   nz,$5CFA
5CEA: 4E          ld   c,(hl)
5CEB: 22 F0 FF    ld   ($FFF0),hl
5CEE: EA 5C 4F    jp   pe,$4F5C
5CF1: 20 10       jr   nz,$5D03
5CF3: 4F          ld   c,a
5CF4: 22 F0 FF    ld   ($FFF0),hl
5CF7: F3          di
5CF8: 5C          ld   e,h
5CF9: 44          ld   b,h
5CFA: 20 10       jr   nz,$5D0C
5CFC: 44          ld   b,h
5CFD: A1          and  c
5CFE: 08          ex   af,af'
5CFF: 4B          ld   c,e
...
6B2E: D5          push de
6B2F: CD 25 33    call $3325
6B32: 11 A0 FF    ld   de,$FFA0
6B35: 19          add  hl,de
6B36: D1          pop  de
6B37: CD 25 33    call $3325
6B3A: C9          ret
...
6E78: 3A F0 8E    ld   a,($8EF0)
6E7B: B6          or   (hl)
6E7C: C2 92 4C    jp   nz,$4C92
...
70EB: 63          ld   h,e
70EC: 0C          inc  c
70ED: C2 0B 62    jp   nz,$620B
70F0: 0B          dec  bc
70F1: 22 0B 03    ld   ($030B),hl
70F4: 71          ld   (hl),c
70F5: 13          inc  de
70F6: 71          ld   (hl),c
70F7: 26 71       ld   h,$71
...
710E: 02          ld   (bc),a
710F: 02          ld   (bc),a
7110: 01 01 FF    ld   bc,$FF01
7113: 01 01 02    ld   bc,$0201
7116: 02          ld   (bc),a
7117: 03          inc  bc
7118: 03          inc  bc
7119: 04          inc  b
...
71B4: 02          ld   (bc),a
71B5: 02          ld   (bc),a
71B6: 01 01 FF    ld   bc,$FF01
71B9: 3A 38 8F    ld   a,($8F38)
71BC: 21 EF 02    ld   hl,$02EF
71BF: E5          push hl
71C0: EF          rst  $28
71C1: C7          rst  $00
71C2: 71          ld   (hl),c
...
7499: C9          ret
749A: AF          xor  a
749B: 32 80 A1    ld   ($A180),a
749E: C3 92 00    jp   $0092
74A1: FF          rst  $38
74A2: 32 00 A0    ld   ($A000),a
74A5: 31 00 90    ld   sp,$9000
...
7511: 09          add  hl,bc
7512: C9          ret
7513: 32 00 A0    ld   ($A000),a
7516: CD CD 81    call $81CD
7519: 43          ld   b,e
...
7851: 03          inc  bc
7852: 43          ld   b,e
7853: C3 83 0D    jp   $0D83
7856: 4D          ld   c,l
7857: CD 8D 00    call $008D
785A: 00          nop
785B: 80          add  a,b
785C: 80          add  a,b
785D: 05          dec  b
